...
def app_specific_action(webdriver, datasets):
    ...
    def measure():
        ...
        def sub_measure():
            ...
            page.wait_until_visible((By.CSS_SELECTOR, ".pinboard-macro"))   # Wait for full pinboard macro to load 
            page.wait_until_visible((By.CSS_SELECTOR, ".pinboard-column"))  # Wait for specific column to load
        sub_measure()
    measure()
